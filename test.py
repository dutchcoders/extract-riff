                    ...
                    if isinstance(subchunk, MxSt):
                        ...
                        for b in d.keys():
                            ...
                            if mxob.s1==4:
                                ...
                                import wave
                                w = wave.open(os.path.join(dest, "{0}_{1}.wav".format(str(mxob.id), os.path.basename(mxob.s3))), 'wb')
                                w.setnchannels(1)
                                ...
                                """
                                import os
                                with open(os.path.join(dest, "{0}_{1}.bmp".format(str(mxob.id), os.path.basename(mxob.s3))), 'wb') as f:
                                    f.write('BM')
                                    f.write('\00\00\00\00')
                                    f.write('\00\00')
                                    f.write('\00\00')
